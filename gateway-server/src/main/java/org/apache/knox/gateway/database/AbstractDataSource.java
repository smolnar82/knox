...
public abstract class AbstractDataSource {
    ...
    //KNOXCLOAK
    public static final String KNOXCLOAK_FED_IDENTITY_TABLE_CREATE_SQL_FILE_NAME = "createKnoxcloakFederatedIdentityTable.sql";
    public static final String KNOXCLOAK_FED_IDENTITY_ATTR_TABLE_CREATE_SQL_FILE_NAME = "createKnoxcloakFederatedIdentityAttributesTable.sql";
    public static final String ORACLE_KNOXCLOAK_FED_IDENTITY_TABLE_CREATE_SQL_FILE_NAME = "createKnoxcloakFederatedIdentityTableOracle.sql";
    public static final String ORACLE_KNOXCLOAK_FED_IDENTITY_ATTR_TABLE_CREATE_SQL_FILE_NAME = "createKnoxcloakFederatedIdentityAttributesTableOracle.sql";
    public static final String DERBY_KNOXCLOAK_FED_IDENTITY_TABLE_CREATE_SQL_FILE_NAME = "createKnoxcloakFederatedIdentityTableDerby.sql";
    public static final String DERBY_KNOXCLOAK_FED_IDENTITY_ATTR_TABLE_CREATE_SQL_FILE_NAME = "createKnoxcloakFederatedIdentityAttributesTableDerby.sql";
